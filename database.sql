...
-- สร้าง Admin คนแรก
-- วิธีใช้: เปลี่ยน YOUR_HASHED_PASSWORD เป็น hash ที่ได้จากรัน: node -e "require('bcryptjs').hash('รหัสของคุณ',10).then(console.log)"
INSERT IGNORE INTO users (username, email, password, role)
VALUES ('admin', 'admin@accdee.shop', 'YOUR_HASHED_PASSWORD', 'admin');
